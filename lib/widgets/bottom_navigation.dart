...
import 'package:ui/screens/timeline_screen.dart';
...
class _BottomNavigationState extends State<BottomNavigation> {
  ...
  ShowcaseActivityTimeline _showcaseActivityTimeline;
  ...
  void initState() {
    ...
    _showcaseActivityTimeline = ShowcaseActivityTimeline();
    _pages = [
      _homeScreen,
      _classesScreen,
      _showcaseActivityTimeline,
      _mainScreen,
    ];
