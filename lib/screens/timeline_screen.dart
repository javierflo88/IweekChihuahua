...
class ShowcaseActivityTimeline extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Showcase(
      title: 'Foto del producción de hoy',
      app: _ActivityTimelineApp(),
      description:
          'Crea un historia donde muestres el como relizaste la blusa de hoy.',
      template: SimpleTemplate(reverse: true),
  ...
  List<Step> _generateData() {
    return <Step>[
      ...
      Step(
        type: Type.checkpoint,
        icon: Icons.work,
        hour: 'Buenas praticas',
        message: 'Buenas praticas',
        duration: 2,
        color: const Color(0xFFF2F2F2),
      ),
      Step(
